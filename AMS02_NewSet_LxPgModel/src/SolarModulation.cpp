...
//TString PATH = "../data";
    ...
    TFile* inFileProton= new TFile("./data/AMS02.root","READ");
...
//grVOYAGER1_Helium_Flux_2016->Draw("pZ");
  ...
  //   grAMS02_Helium_Flux->Draw("pZ"); // METTERE...?
    ...
    if (indexKmodel == 1)
    {
    outFile= new TFile(Form("./out/TGraph_Flux_data_LIS%d_Z%d_A%d_BR%d_DCStandardNEWSET.root",kLISModel,zz,aa,br),"recreate");
    }
