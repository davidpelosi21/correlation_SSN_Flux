...
// ---- NT Constructor ---
SolarModulation::SolarModulation(double Z, double A, int LIS, int iKScale, double ThisKScale2, int iXiD, int Kmodel){
...
void SolarModulation::Iterate_ThisKScale(double iKScale){ // Grid gia definite
    //indexKScale= iKScale;
    ThisKScale2 = iKScale;
...
//metodo per plot relativi a BR, con dati di AMS relativi alla BR e modello 
...
//TString PATH = "../data";
    ...
    // ---- get AMS02 data vs Ekn ----
    TFile* inFileProton= new TFile("./data/grAMS02_ProtonHelium_vs_Ekn_vs_Time_DEC2017.root","READ");
    inFileProton->cd();
    TGraphErrors* grAMS02_Proton_Flux_2015 = (TGraphErrors*)inFileProton->Get(Form("grProton_vs_Ekn_T%d",br));
    grAMS02_Proton_Flux_2015->SetMarkerStyle(20);
    grAMS02_Proton_Flux_2015->SetMarkerColor(kBlack);
    grAMS02_Proton_Flux_2015->SetMarkerSize(0.8);
    inFileProton->Close();
