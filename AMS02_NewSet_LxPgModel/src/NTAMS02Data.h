...
class NTAMS02Data{
 ...
 public:
  ...
  static const int nTimeAMS02_Proton  = 114; // 79+2 with UTTPS off: 81
  static const int nTimeAMS02_Helium  = 114; // 79+2 with UTTPS off: 81

  // ---- number of EKN points ----
  //static const int nEknAMS02_Proton   = 45; // R>1 GV [up 60GV: 45 | up 100GV: 52 | up 2TV: 74];
  static const int nEknAMS02_Proton   = 31; // R>1 GV [up 60GV: 45 | up 100GV: 52 | up 2TV: 74];
